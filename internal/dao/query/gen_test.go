...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.ItemInfoTab.UnderlyingDB().Statement.Context,
		qCtx.ShopInfoTab.UnderlyingDB().Statement.Context,
		qCtx.SkuInfoTab.UnderlyingDB().Statement.Context,
		qCtx.SkuInventoryTab.UnderlyingDB().Statement.Context,
	} {
